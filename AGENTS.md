...
1. Every time a new Codex window/session is opened for a task that may modify code, create a new branch with a fresh isolated git worktree from the latest `origin/main` before making changes.
