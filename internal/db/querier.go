...
type Querier interface {
	...
	ResetCanonicalSiteFixSourceConflictForReprepare(ctx context.Context, arg ResetCanonicalSiteFixSourceConflictForReprepareParams) (SiteChangeApplication, error)
