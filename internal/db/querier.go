...
type Querier interface {
	...
	ActivateSiteFixMeasurement(ctx context.Context, arg ActivateSiteFixMeasurementParams) (SiteFixMeasurement, error)
	...
	ArchiveGEOPromptOverflow(ctx context.Context, arg ArchiveGEOPromptOverflowParams) ([]GeoPrompt, error)
	...
	ClaimDueSiteFixMeasurement(ctx context.Context, nowAt pgtype.Timestamptz) (SiteFixMeasurement, error)
	ClaimFailedTerminalSiteFixMeasurementHandoffAlert(ctx context.Context, arg ClaimFailedTerminalSiteFixMeasurementHandoffAlertParams) (SiteFixMeasurementHandoffOutbox, error)
	...
	ClaimSiteFixMeasurementHandoff(ctx context.Context, arg ClaimSiteFixMeasurementHandoffParams) (SiteFixMeasurementHandoffOutbox, error)
	...
	CloseSiteFixMeasurementOpenCheckpoints(ctx context.Context, arg CloseSiteFixMeasurementOpenCheckpointsParams) ([]SiteFixMeasurementCheckpoint, error)
	...
	CompleteFailedTerminalSiteFixMeasurementHandoffAlert(ctx context.Context, arg CompleteFailedTerminalSiteFixMeasurementHandoffAlertParams) (SiteFixMeasurementHandoffOutbox, error)
	CompleteSEODoctorRun(ctx context.Context, arg CompleteSEODoctorRunParams) (SeoDoctorRun, error)
	CompleteSiteFixMeasurementCheckpoint(ctx context.Context, arg CompleteSiteFixMeasurementCheckpointParams) (SiteFixMeasurementCheckpoint, error)
	CompleteSiteFixMeasurementHandoff(ctx context.Context, arg CompleteSiteFixMeasurementHandoffParams) (SiteFixMeasurementHandoffOutbox, error)
	...
	CountActiveGrowthRadarWatchlist(ctx context.Context, projectID uuid.UUID) (int64, error)
	...
	CountUnrepresentedActiveLegacyGrowth(ctx context.Context, projectID uuid.UUID) (int64, error)
	...
	CreateCanonicalizedGrowthOpportunityAlias(ctx context.Context, arg CreateCanonicalizedGrowthOpportunityAliasParams) (GrowthOpportunityWorkAlias, error)
	CreateContentAction(ctx context.Context, arg CreateContentActionParams) (ContentAction, error)
	CreateContentTargetPlan(ctx context.Context, arg CreateContentTargetPlanParams) (ContentTargetPlan, error)
	CreateContentTargetPlanItem(ctx context.Context, arg CreateContentTargetPlanItemParams) (ContentTargetPlanItem, error)
	...
	CreateDoctorGrowthEvidenceAlias(ctx context.Context, arg CreateDoctorGrowthEvidenceAliasParams) (GrowthOpportunityWorkAlias, error)
	...
	CreateGrowthStageEvent(ctx context.Context, arg CreateGrowthStageEventParams) (GrowthStageEvent, error)
	...
	CreatePlatformTargetContext(ctx context.Context, arg CreatePlatformTargetContextParams) (PlatformTargetContext, error)
	...
	CreateSiteFixMeasurement(ctx context.Context, arg CreateSiteFixMeasurementParams) (SiteFixMeasurement, error)
	...
	DeferSiteFixMeasurementCheckpoint(ctx context.Context, arg DeferSiteFixMeasurementCheckpointParams) (SiteFixMeasurementCheckpoint, error)
	...
	EnqueueSiteFixMeasurementHandoff(ctx context.Context, arg EnqueueSiteFixMeasurementHandoffParams) (SiteFixMeasurementHandoffOutbox, error)
	...
	GetActiveContentTargetPlanByOpportunity(ctx context.Context, arg GetActiveContentTargetPlanByOpportunityParams) (ContentTargetPlan, error)
	GetActiveGrowthCutoverSession(ctx context.Context, projectID uuid.UUID) (GrowthCutoverSession, error)
	GetActivePlatformContentContract(ctx context.Context, platform string) (PlatformContentContract, error)
	...
	GetCanonicalSiteFixByWorkSignatureForUpdate(ctx context.Context, arg GetCanonicalSiteFixByWorkSignatureForUpdateParams) (SiteFix, error)
	...
	GetContentTargetPlanForProject(ctx context.Context, arg GetContentTargetPlanForProjectParams) (ContentTargetPlan, error)
	GetCurrentPlatformTargetContext(ctx context.Context, arg GetCurrentPlatformTargetContextParams) (PlatformTargetContext, error)
	...
	GetEvidenceObservation(ctx context.Context, arg GetEvidenceObservationParams) (EvidenceObservation, error)
	GetEvidenceRun(ctx context.Context, arg GetEvidenceRunParams) (EvidenceRun, error)
	...
	GetGrowthStageSetting(ctx context.Context, projectID uuid.UUID) (GrowthStageSetting, error)
	...
	GetLatestGrowthStageEvent(ctx context.Context, projectID uuid.UUID) (GrowthStageEvent, error)
	GetLatestSiteFixMeasurementForFix(ctx context.Context, arg GetLatestSiteFixMeasurementForFixParams) (SiteFixMeasurement, error)
	GetLatestSiteFixMeasurementHandoff(ctx context.Context, arg GetLatestSiteFixMeasurementHandoffParams) (SiteFixMeasurementHandoffOutbox, error)
	GetLegacyGrowthIntendedTarget(ctx context.Context, arg GetLegacyGrowthIntendedTargetParams) (GetLegacyGrowthIntendedTargetRow, error)
	...
	GetMigrationReviewItem(ctx context.Context, arg GetMigrationReviewItemParams) (MigrationReviewItem, error)
	...
	GetOrCreateSiteFixMeasurementCheckpoint(ctx context.Context, arg GetOrCreateSiteFixMeasurementCheckpointParams) (SiteFixMeasurementCheckpoint, error)
	GetOrCreateSiteFixMeasurementLearning(ctx context.Context, arg GetOrCreateSiteFixMeasurementLearningParams) (SiteFixMeasurementLearning, error)
	GetOrCreateSiteFixMeasurementQualityRecord(ctx context.Context, arg GetOrCreateSiteFixMeasurementQualityRecordParams) (SiteFixMeasurementQualityRecord, error)
	GetOrCreateSiteFixMeasurementTerminalOutcome(ctx context.Context, arg GetOrCreateSiteFixMeasurementTerminalOutcomeParams) (SiteFixMeasurementTerminalOutcome, error)
	...
	GetSiteFixMeasurement(ctx context.Context, arg GetSiteFixMeasurementParams) (SiteFixMeasurement, error)
	GetSiteFixMeasurementGeneration(ctx context.Context, arg GetSiteFixMeasurementGenerationParams) (SiteFixMeasurement, error)
	GetSiteFixMeasurementResultsDetail(ctx context.Context, arg GetSiteFixMeasurementResultsDetailParams) (GetSiteFixMeasurementResultsDetailRow, error)
	GetSiteFixMeasurementTerminalOutcome(ctx context.Context, arg GetSiteFixMeasurementTerminalOutcomeParams) (GetSiteFixMeasurementTerminalOutcomeRow, error)
	...
	GetWorkSignatureForGrowthEvidenceMergeForUpdate(ctx context.Context, arg GetWorkSignatureForGrowthEvidenceMergeForUpdateParams) (WorkSignatureRegistry, error)
	GrowthOpportunityExecutionGuard(ctx context.Context, arg GrowthOpportunityExecutionGuardParams) (bool, error)
	...
	ListContentTargetPlanItems(ctx context.Context, planID uuid.UUID) ([]ContentTargetPlanItem, error)
	...
	ListEvidenceObservations(ctx context.Context, arg ListEvidenceObservationsParams) ([]EvidenceObservation, error)
	ListEvidenceRuns(ctx context.Context, arg ListEvidenceRunsParams) ([]EvidenceRun, error)
	ListEvidenceRunsForConsumers(ctx context.Context, arg ListEvidenceRunsForConsumersParams) ([]ListEvidenceRunsForConsumersRow, error)
	...
	ListOperationalMigrationReviewItems(ctx context.Context, arg ListOperationalMigrationReviewItemsParams) ([]MigrationReviewItem, error)
	...
	ListPlatformTargetContexts(ctx context.Context, arg ListPlatformTargetContextsParams) ([]PlatformTargetContext, error)
	...
	ListResultsFeedRows(ctx context.Context, arg ListResultsFeedRowsParams) ([]ListResultsFeedRowsRow, error)
	...
	ListSiteFixMeasurementCheckpoints(ctx context.Context, arg ListSiteFixMeasurementCheckpointsParams) ([]SiteFixMeasurementCheckpoint, error)
	ListSiteFixMeasurementsForResults(ctx context.Context, arg ListSiteFixMeasurementsForResultsParams) ([]ListSiteFixMeasurementsForResultsRow, error)
	...
	ListVerifiedRequiredSiteFixesMissingMeasurement(ctx context.Context, limitRows int32) ([]SiteFix, error)
	ListVisibilityActionRows(ctx context.Context, arg ListVisibilityActionRowsParams) ([]ListVisibilityActionRowsRow, error)
	ListWorkSignaturesForRelationship(ctx context.Context, arg ListWorkSignaturesForRelationshipParams) ([]WorkSignatureRegistry, error)
	...
	LockLegacyGrowthIntendedTarget(ctx context.Context, arg LockLegacyGrowthIntendedTargetParams) (LockLegacyGrowthIntendedTargetRow, error)
	...
	MarkGEOPromptsObserved(ctx context.Context, arg MarkGEOPromptsObservedParams) ([]GeoPrompt, error)
	MarkGrowthCutoverSessionEntriesRolledBack(ctx context.Context, arg MarkGrowthCutoverSessionEntriesRolledBackParams) (int64, error)
	...
	MarkLegacyGrowthOpportunityCanonical(ctx context.Context, arg MarkLegacyGrowthOpportunityCanonicalParams) (SeoOpportunity, error)
	...
	NextPlatformTargetContextVersion(ctx context.Context, arg NextPlatformTargetContextVersionParams) (int32, error)
	...
	ReconcileVerifiedSiteFixMeasurementHandoffs(ctx context.Context, arg ReconcileVerifiedSiteFixMeasurementHandoffsParams) ([]SiteFixMeasurementHandoffOutbox, error)
	...
	RetrySiteFixMeasurementHandoff(ctx context.Context, arg RetrySiteFixMeasurementHandoffParams) (SiteFixMeasurementHandoffOutbox, error)
	...
	RollbackGrowthCutoverCanonical(ctx context.Context, arg RollbackGrowthCutoverCanonicalParams) (int64, error)
	RollbackGrowthCutoverDuplicate(ctx context.Context, arg RollbackGrowthCutoverDuplicateParams) (int64, error)
	RollbackGrowthCutoverMaterialized(ctx context.Context, arg RollbackGrowthCutoverMaterializedParams) (int64, error)
	...
	StartGrowthCutoverSession(ctx context.Context, arg StartGrowthCutoverSessionParams) (GrowthCutoverSession, error)
	...
	UpdateContentTargetPlanStatus(ctx context.Context, arg UpdateContentTargetPlanStatusParams) (ContentTargetPlan, error)
	...
	UpdateGrowthRadarWatchlistStageScore(ctx context.Context, arg UpdateGrowthRadarWatchlistStageScoreParams) (GrowthRadarWatchlist, error)
	UpdateGrowthStageEventStatus(ctx context.Context, arg UpdateGrowthStageEventStatusParams) (GrowthStageEvent, error)
	...
	UpdateSiteFixMeasurementBaseline(ctx context.Context, arg UpdateSiteFixMeasurementBaselineParams) (SiteFixMeasurement, error)
	...
	UpsertGrowthStageSetting(ctx context.Context, arg UpsertGrowthStageSettingParams) (GrowthStageSetting, error)
	...
	UpsertWorkRelationship(ctx context.Context, arg UpsertWorkRelationshipParams) (WorkRelationship, error)
